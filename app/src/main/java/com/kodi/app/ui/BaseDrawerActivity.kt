...
import com.kodi.app.Activities.PrivacyPolicy
    ...
    private fun handleDrawerClick(menuId: Int) {
        when (menuId) {
            ...
            R.id.nav_helpus -> {
                ...
                intent.putExtra(Intent.EXTRA_EMAIL, arrayOf("help@willdev.in")) // Put Your Support Email Here
